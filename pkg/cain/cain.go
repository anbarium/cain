...
func IncBackup(o IncBackupOptions) (string, error) {
	...
	log.Println("Calculating paths. This may take a while...")
	fromToPathsAllPods, err := utils.GetIncFromAndToPathsFromK8s(k8sClient, pods, o.Namespace, o.Container, o.Keyspace, tag, dstBasePath, o.CassandraDataDir)
	if err != nil {
		return "", err
	}
	...
	log.Println("Cleaning up incremental backup folder")
	if err := skbn.CleanUp(k8sClient, fromToPathsAllPods); err != nil {
		return "", err
	}
